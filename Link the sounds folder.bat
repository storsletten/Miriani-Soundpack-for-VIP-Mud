...
mode con: cols=150
title Linking the Miriani Soundpack Sounds
timeout /t 1 >nul
...
echo Done^^! The path to the Soundpack Sounds folder has been added to your soundpack configuration.
pause
exit /b 0

:WrongFolder
echo Sorry, it doesn't seem like this installation script is located in the right folder.
